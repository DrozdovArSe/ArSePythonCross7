...
class Form5(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.tableWidget.setItem(0, 0,
                                 QTableWidgetItem('Когда вы научились читать?'))
        self.tableWidget.setItem(0, 1, QTableWidgetItem(answers[1]))

        self.tableWidget.setItem(1, 0,
                                 QTableWidgetItem('Ваш любимый предмет в школе?'))
        self.tableWidget.setItem(1, 1, QTableWidgetItem(answers[2]))

        self.tableWidget.setItem(2, 0,
                                 QTableWidgetItem('Как вы закончили школу?'))
        self.tableWidget.setItem(2, 1, QTableWidgetItem(answers[0]))
